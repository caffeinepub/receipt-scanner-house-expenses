...
export class Backend implements backendInterface {
    ...
    async addExpenseEntry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: number, arg5: string, arg6: bigint): Promise<ExpenseEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.addExpenseEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntries(): Promise<Array<ExpenseEntry>> {
        if (this.processError) {
            try {
    ...
    async getEntriesForSheet(arg0: string): Promise<Array<ExpenseEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesForSheet(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateExpenseEntry(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: number, arg6: string, arg7: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateExpenseEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
